...
State.variables.guard = new Character(setup.identities.guard, setup.routes.nightGuardPatrol, setup.actionOrders.nightGuardActions);
State.variables.governor = new Character(setup.identities.governor, setup.routes.governorRoute, setup.actionOrders.governorActions);